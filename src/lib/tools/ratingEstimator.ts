...
export const questions: QuizQuestion[] = [
	...
	{
		id: 'rally',
		prompt: 'Easy rally, normal speed — how many times over the net does a point usually last?',
		options: [
			{ value: 2.0, label: '2–4, lots in the net' },
			{ value: 3.0, label: '5–8 if they keep it easy' },
			{ value: 3.5, label: 'A decent rally if nobody speeds it up' },
			{ value: 4.0, label: 'Long rallies, and I can reset a hard one' },
...
const PRACTICE_LINES: Record<QuestionId, string> = {
	...
	rally: 'Easy rallies at normal speed: keep the ball over the net. Reset a hard one instead of ending the point in 2–4 shots.',
